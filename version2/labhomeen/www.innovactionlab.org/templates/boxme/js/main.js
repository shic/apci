...
var BoxmeAnimation = function(){
	...
	jQuery(".animated-area").on("animate-it", function() {
		...
		cf.find(".animated").each(function() {
			jQuery(this).css("-webkit-animation-duration","http://www.innovactionlab.org/templates/boxme/js/0.6s");
			jQuery(this).css("-moz-animation-duration","http://www.innovactionlab.org/templates/boxme/js/0.6s");
			jQuery(this).css("-ms-animation-duration","http://www.innovactionlab.org/templates/boxme/js/0.6s");
			jQuery(this).css("animation-duration","http://www.innovactionlab.org/templates/boxme/js/0.6s");
